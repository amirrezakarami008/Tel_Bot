...
ادمین از گزینه «📚 آپلود فایل دانش AI» می‌تواند یک فایل TXT یا JSON تا حجم ۱ مگابایت
آپلود کند. فایل قبلی جایگزین می‌شود و پاسخ‌های AI بر اساس محتوای آن ساخته می‌شوند.
برای پرسش‌های شخصی، اطلاعات فقط وقتی به AI داده می‌شود که شناسه تلگرام پیام‌دهنده در
جدول کاربران پیدا شود؛ شناسه ارسالی داخل متن کاربر قابل اعتماد نیست.
